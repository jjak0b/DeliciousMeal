<?php
    ...
    foreach ($piatti as $key => $piatto) {
        ...
        $query_ingredienti = quick_select2( array("pi.id_ingrediente", "i.nome", "i.prezzo", "pi.quantita_ingrediente", "p.categoria"),
                                            array("pietanze p", "ingredienti i", "ingredienti_pietanze pi"),
                                            array( "p.id", "i.id", "p.id" ),
                                            array( "pi.id_pietanza", "pi.id_ingrediente", $id )
                                            );
        $query_ingredienti.= " ORDER BY i.nome";
        $ingredienti = [];
        $result_ing = mysqli_query($connection, $query_ingredienti);
