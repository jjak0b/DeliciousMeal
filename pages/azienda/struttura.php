...
<html>
    <head>
        ...
        ?>
        <script type="text/javascript" src="scripts/js/charts/loader.js"></script>
    </head>
    <body>
        <?php
        ...
        <div class="main">
            <div class="container">
                <h2 class="center">Organigramma Aziendale</h2>
                <p style="text-align: center;">
                    La qualità dei nostri piatti è quello che rende l'immagine della nostra azienda, proprio per questo gestiamo 
                    al meglio le Unità Organizzative che la compongono e le schematizziamo nel grafico seguente:
                </p>
                <div class="center" id="orgchart_div">
                    <img style="width: 100%;" src="img/organigramma_funzionale.png" alt="Organigramma Funzionale">
                </div>
                <!--<ul class="tree">
                    <li>
                        <a>Direttore</a>
